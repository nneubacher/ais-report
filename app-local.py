...
if not os.environ.get("OLLAMA_MODEL"):
    print("WARNING: OLLAMA_MODEL not set. Defaulting to 'llama3'. Make sure you have run 'ollama pull llama3'")
...
def call_local_ollama(prompt):
    ...
    try:
        ...
        error_msg = f"Connection failed. Is Ollama running? (Tried to connect to {OLLAMA_BASE_URL})"
